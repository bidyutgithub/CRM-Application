   ...
   /**
    * controller for the user resources.
    * only the user of type ADMIN should be able to perform thr operation
...
const fetchByStatus = async (userStatusReq, res) => {
   ...
   exports.findAll = async (req,res) =>{
    ...
    if(user.length > 0){
        ...
        res.status(200).send({
           message : `User with this is[${userIdReq}] is not present`
        })
     }
